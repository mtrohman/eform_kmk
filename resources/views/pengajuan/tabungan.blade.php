...
@section('form_content')
	<form id="form-tabungan" role="form" autocomplete="on" method="POST" action='{{ route("guest.store", ['form' => request()->query('form','')]) }}' enctype="multipart/form-data">
	  {{-- <p class="mw-80 m-b-25">Want it to be more Descriptive and User-Friendly, We Made it possible, Use Separated Form Layouts Structure to Presentation your Form Fields. --}}
	    ...
	    <div class="row">
	        ...
	        {{-- Bilah Kanan --}}
	        <div class="col-md-6">
	        	<p class="mt-2">Informasi Tabungan</p>
	            <div class="form-group-attached">
	            	<div class="form-group form-group-default required">
	                    <label>Jenis Tabungan</label>
	                    <input type="text" class="form-control" name="jenis_tabungan" placeholder="" required>
	                </div>

	                {{-- <div class="form-group form-group-default required">
	                    <label>Alasan Pembukaan</label>
	                    <input type="text" class="form-control" name="alasan" placeholder="" required>
	                </div> --}}

	                <div class="form-group form-group-default required">
	                    <label>Jumlah Setoran Awal</label>
